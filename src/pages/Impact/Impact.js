            ...
            <div className="row">
              <div className="col-lg-6">
                ...
                <p className="cutomer-quote">
                  The aim of TOFA Academy is to Build a Network of Credible Suppliers all over Africa in Order to Meet Both Local and Global Demand. 
                </p>
                ...
                <div className="d-flex justify-content-start play-icon-wrap">
                  ...
                  <p className="play-icon-text"><a href="#"> Watch video</a></p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            <div className="row mb-5 pb-5">
              <div className="col-lg-7">
                ...
                <p>The big mission for Traders of Africa is to facilitate trade across all <span>54 countries</span> <br />in Africa, through strategic partnerships. Currently, we operate in <span>Nigeria, Benin, <br />Togo, Cameroon and Mali.</span> </p>
            ...
            <div className="row">
              ...
              <div className="col-lg-7 padding-left">
                ...
                <p>As we expand, we will continue to work with smallholder farmers, aggregators, and individuals to provide them with training, financing and off-take through TOFA Academy. </p>
                <p>We are building a strong network of credible agro traders who can meet the ever increasing demand, both locally and globally. See our numbers below.</p>
