      ...
      <div className="container py-4">
        ...
        <div className="row py-5">
          <div className="col-lg-12">
            <h3 className="modal-sub-title">Order Summary</h3>
          </div>
              ...
              <table className="table table-borderless">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      {orderInfo.countryOfOrigin && orderInfo.countryOfOrigin}
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>
                      USD {orderInfo.cost && numberWithCommas(orderInfo.cost)}
                    </td>
                  </tr>
                </tbody>
              </table>
              ...
              <div className="order-history ">
                ...
                <div className="order-history-details-ctn">
                  ...
                  <div className="order-history-details">
                    ...
                    <p>
                      Uploaded and processed requirements in the payment type of{" "}
              ...
              <div className="order-history ">
                ...
                <div className="order-history-details-ctn">
                  ...
                  <div className="order-history-details">
                    ...
                    <p>
                      Uploaded and processed requirements in the payment type of{" "}
                      {orderInfo && orderInfo.paymentTerm} with TOFA has been
                      confirmed
                    </p>
                    <p>
                      {" "}
              ...
              <div className="order-history ">
                ...
                <div className="order-history-details-ctn">
                  ...
                  <div className="order-history-details">
                    ...
                    <p>
                      If you didn't request your order to be cancelled, contact
                      us <Link to=""> here</Link> to get full details.
                    </p>
                  </div>
                </div>
              </div>
